# -*- coding: utf-8 -*-
"""DeepSeekCode_0_6_0_MoE_bias_update.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17jJRjfFpcx6zwliud3NAEG5obduQU46R
...
class MoE(MoE):
    def old_update_expert_bias(self):
        """
...
class MoE(MoE):
    def update_expert_bias(self):
        ...
        expert_load = self.step_expert_counts / self.step_total_tokens
        # Boolマスクを作成
        overloaded  = expert_load > self.expected_load   # 使われ過ぎ
        underloaded = expert_load < self.expected_load   # 使われな過ぎ
        with torch.no_grad():
            #  Boolマスクで代入
            self.expert_bias[overloaded]  -= self.bias_update_speed   # γ 下げる
            self.expert_bias[underloaded] += self.bias_update_speed   # γ 上げる
